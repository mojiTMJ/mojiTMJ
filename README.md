...
<!-- BLOG-POST-LIST:START -->- [Plane vs Jira vs Linear &lpar;2026&rpar;: The Open-Source Verdict](https://dev.to/shaam_ai/plane-vs-jira-vs-linear-2026-the-open-source-verdict-1pb) <kbd>Sat Sep 19 2026 3:44 AM</kbd>- [I Built a Restaurant Website Using Only HTML – My First Frontend Project Series. Part-2](https://dev.to/dilesh596/i-built-a-restaurant-website-using-only-html-my-first-frontend-project-series-part-2-4o27) <kbd>Sat Sep 19 2026 3:43 AM</kbd>- [I built an open-source, zero-telemetry local AI proxy daemon for absolute data sovereignty](https://dev.to/joxkxer/i-built-an-open-source-zero-telemetry-local-ai-proxy-daemon-for-absolute-data-sovereignty-1g69) <kbd>Sat Sep 19 2026 3:36 AM</kbd>- [The &quot;DevRel Journey&quot; Angle](https://dev.to/dilesh596/the-devrel-journey-angle-3fa7) <kbd>Sat Sep 19 2026 3:24 AM</kbd>- [Oracle PL/SQL Exception Handling](https://dev.to/f8wamhn/oracle-plsql-exception-handling-inc) <kbd>Sat Sep 19 2026 3:11 AM</kbd><!-- BLOG-POST-LIST:END -->
