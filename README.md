...
<!-- BLOG-POST-LIST:START -->- [99.7% Rejected in 84ms: Why I Stopped Making the Generator Smarter](https://dev.to/hidetzu/997-rejected-in-84ms-why-i-stopped-making-the-generator-smarter-5em0) <kbd>Sun Sep 06 2026 3:34 AM</kbd>- [Returning RFC 9457 Problem Details from Go Validation Errors](https://dev.to/onurcinar/returning-rfc-9457-problem-details-from-go-validation-errors-4nb7) <kbd>Sun Sep 06 2026 3:32 AM</kbd>- [8 Agent Skills and my first MCP server published to npm](https://dev.to/alpha018/8-agent-skills-and-my-first-mcp-server-published-to-npm-3fmi) <kbd>Sun Sep 06 2026 3:26 AM</kbd>- [8 Agent Skills y mi primer servidor MCP publicado en npm](https://dev.to/alpha018/8-agent-skills-y-mi-primer-servidor-mcp-publicado-en-npm-4jc9) <kbd>Sun Sep 06 2026 3:26 AM</kbd>- [Replacing Myself With AI, One Cognitive Habit at a Time](https://dev.to/the_leon_odor/replacing-myself-with-ai-one-cognitive-habit-at-a-time-175k) <kbd>Sun Sep 06 2026 3:23 AM</kbd><!-- BLOG-POST-LIST:END -->
