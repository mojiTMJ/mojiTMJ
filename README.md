...
<!-- BLOG-POST-LIST:START -->- [I built an AI assistant that lives on my Mac instead of in a chat tab](https://dev.to/yisrael_gottlieb_moe/i-built-an-ai-assistant-that-lives-on-my-mac-instead-of-in-a-chat-tab-1l6n) <kbd>Sat Sep 12 2026 3:02 PM</kbd>- [I built a CSV chart page that shows a SHA of your file so the chart can’t invent numbers](https://dev.to/therealcpain/i-built-a-csv-chart-page-that-shows-a-sha-of-your-file-so-the-chart-cant-invent-numbers-2dlm) <kbd>Sat Sep 12 2026 3:01 PM</kbd>- [TokenPrint: An Open-Source 3D Visual Debugger for LLMs and Transformers](https://dev.to/sudharsan_nef/tokenprint-an-open-source-3d-visual-debugger-for-llms-and-transformers-2jca) <kbd>Sat Sep 12 2026 3:01 PM</kbd>- [Stackness launch](https://dev.to/gosen/stackness-launch-54fo) <kbd>Sat Sep 12 2026 3:01 PM</kbd>- [My Copy Buttons Vanished on Production. The Bug Was Three WordPress Layers Deep](https://dev.to/aiinsider/my-copy-buttons-vanished-on-production-the-bug-was-three-wordpress-layers-deep-203j) <kbd>Sat Sep 12 2026 2:59 PM</kbd><!-- BLOG-POST-LIST:END -->
