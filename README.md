...
<!-- BLOG-POST-LIST:START -->- [G4 Fractional VMs are now available on Google Cloud!](https://dev.to/googleai/g4-fractional-vms-are-now-available-on-google-cloud-knp) <kbd>Wed Jun 10 2026 3:38 PM</kbd>- [I built an open-source CLI that tells you if ChatGPT cites your brand — and what to do about it](https://dev.to/alex-isa/i-built-an-open-source-cli-that-tells-you-if-chatgpt-cites-your-brand-and-what-to-do-about-it-31gg) <kbd>Wed Jun 10 2026 3:37 PM</kbd>- [CLI over MCP: a small Chrome DevTools experiment in Copilot CLI](https://dev.to/maximsaplin/cli-over-mcp-a-small-chrome-devtools-experiment-in-copilot-cli-5gpi) <kbd>Wed Jun 10 2026 3:25 PM</kbd>- [I Built My Own API Gateway in Rust — Here&#39;s What I Learned](https://dev.to/gudhalarya/i-built-my-own-api-gateway-in-rust-heres-what-i-learned-38ne) <kbd>Wed Jun 10 2026 3:25 PM</kbd>- [Proxy OpenAI Through Kong AI Gateway on Kubernetes](https://dev.to/thegatewayguy/proxy-openai-through-kong-ai-gateway-on-kubernetes-1p83) <kbd>Wed Jun 10 2026 3:24 PM</kbd><!-- BLOG-POST-LIST:END -->
