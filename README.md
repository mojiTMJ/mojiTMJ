...
<!-- BLOG-POST-LIST:START -->- [Cutting IIoT Message Payloads by 90% with Compression over RabbitMQ in Spring Boot](https://dev.to/mwiginton/cutting-iiot-message-payloads-by-90-with-compression-over-rabbitmq-in-spring-boot-1494) <kbd>Mon Jul 27 2026 2:32 PM</kbd>- [Opus 5: More Capability? Definitely a Better Liar.](https://dev.to/raleighschickel/opus-5-more-capability-definitely-a-better-liar-125g) <kbd>Mon Jul 27 2026 2:29 PM</kbd>- [Make any scan searchable - locally, no Python, no Ghostscript, no upload](https://dev.to/deeplab/make-any-scan-searchable-locally-no-python-no-ghostscript-no-upload-2g87) <kbd>Mon Jul 27 2026 2:24 PM</kbd>- [I built a memory engine for AI agents. No cloud required.](https://dev.to/ajianaz/i-built-a-memory-engine-for-ai-agents-no-cloud-required-47mo) <kbd>Mon Jul 27 2026 2:17 PM</kbd>- [Archetype: The Chef](https://dev.to/druid628/archetype-the-chef-139c) <kbd>Mon Jul 27 2026 2:15 PM</kbd><!-- BLOG-POST-LIST:END -->
