...
<!-- BLOG-POST-LIST:START -->- [Subscription-per-environment was never the real question](https://dev.to/webruster/subscription-per-environment-was-never-the-real-question-3che) <kbd>Wed Jul 29 2026 2:41 AM</kbd>- [I put my entire CRUD in one React hook. It felt efficient. Then it wasn’t.](https://dev.to/kiaravzm/i-put-my-entire-crud-in-one-react-hook-it-felt-efficient-then-it-wasnt-10mf) <kbd>Wed Jul 29 2026 2:40 AM</kbd>- [Waking a dead service worker with Web Push, from a Cloudflare Worker](https://dev.to/mfauveau/waking-a-dead-service-worker-with-web-push-from-a-cloudflare-worker-1jnm) <kbd>Wed Jul 29 2026 2:38 AM</kbd>- [I built a collection of 100% client-side developer tools &lpar;JSON, Base64, Crontab&rpar;. No server uploads, purely secure.](https://dev.to/jiang_str_3c8ce5ace5e7f00/i-built-a-collection-of-100-client-side-developer-tools-json-base64-crontab-no-server-26bp) <kbd>Wed Jul 29 2026 2:33 AM</kbd>- [BloodHound for AI Agents Means We&#39;ve Officially Given Up Pretending This Is Simple](https://dev.to/coridev/bloodhound-for-ai-agents-means-weve-officially-given-up-pretending-this-is-simple-37ph) <kbd>Wed Jul 29 2026 2:25 AM</kbd><!-- BLOG-POST-LIST:END -->
