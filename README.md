...
<!-- BLOG-POST-LIST:START -->- [I built an open-source market maker for prediction markets &lpar;Polymarket/CLOB&rpar; — here&#39;s how it works](https://dev.to/harrieronchain/i-built-an-open-source-market-maker-for-prediction-markets-polymarketclob-heres-how-it-works-5aam) <kbd>Fri Jun 19 2026 3:16 PM</kbd>- [How I Slashed AI API Costs 60% as a Cloud Architect](https://dev.to/swift-logic-io218/how-i-slashed-ai-api-costs-60-as-a-cloud-architect-3n6) <kbd>Fri Jun 19 2026 3:11 PM</kbd>- [GBase 8a Query Optimization in Practice: EXPLAIN, Materialized Views, CTE, and Common Tuning Techniques](https://dev.to/michaelfv/gbase-8a-query-optimization-in-practice-explain-materialized-views-cte-and-common-tuning-1d4j) <kbd>Fri Jun 19 2026 3:10 PM</kbd>- [Agentic Coding in Mid-2026: What Changed and How I Actually Use It](https://dev.to/pavelespitia/agentic-coding-in-mid-2026-what-changed-and-how-i-actually-use-it-2kl4) <kbd>Fri Jun 19 2026 3:09 PM</kbd>- [We Open-Sourced a 500-Line Python Module That Solves Agent Crash Recovery](https://dev.to/hhhfs9s7y9code/we-open-sourced-a-500-line-python-module-that-solves-agent-crash-recovery-22m8) <kbd>Fri Jun 19 2026 3:07 PM</kbd><!-- BLOG-POST-LIST:END -->
