...
<!-- BLOG-POST-LIST:START -->- [TLS and mTLS for Infra Services: A Production Deep Dive for Solo Devs and Small Startups](https://dev.to/instanceofgod/tls-and-mtls-for-infra-services-a-production-deep-dive-for-solo-devs-and-small-startups-2j0g) <kbd>Sat Jul 25 2026 1:25 PM</kbd>- [AI Evaluation Series &lpar;06&rpar;: DeepEval in Practice — Enterprise Agent Evaluation Suite](https://dev.to/wonderlab/ai-evaluation-series-06-deepeval-in-practice-enterprise-agent-evaluation-suite-22c) <kbd>Sat Jul 25 2026 1:20 PM</kbd>- [tool to convert light novel chapters into EPUBs &lpar;linktoepub.com&rpar;](https://dev.to/prasad_ghanwat_b0fbc908f2/i-built-a-zero-friction-web-tool-to-convert-articles-to-epubs-linktoepubcom-dgn) <kbd>Sat Jul 25 2026 1:19 PM</kbd>- [CompressPower](https://dev.to/digital_web/compresspower-27fj) <kbd>Sat Jul 25 2026 1:14 PM</kbd>- [Several agents, one dirty index: disposable multi-repo workspaces for Claude Code](https://dev.to/riccardo_cereghino/several-agents-one-dirty-index-disposable-multi-repo-workspaces-for-claude-code-1936) <kbd>Sat Jul 25 2026 1:13 PM</kbd><!-- BLOG-POST-LIST:END -->
