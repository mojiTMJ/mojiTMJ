...
<!-- BLOG-POST-LIST:START -->- [How I Built a Peptide Dosage Calculator with Next.js — and Why SSR Matters More Than You Think](https://dev.to/jamin_e16996ba0e309177/how-i-built-a-peptide-dosage-calculator-with-nextjs-and-why-ssr-matters-more-than-you-think-3fk8) <kbd>Sun Jul 26 2026 2:47 AM</kbd>- [Useful article on how to containerize your claude code instance](https://dev.to/saheel_acharya_b1eac99389/useful-article-on-how-to-containerize-your-claude-code-instance-35cg) <kbd>Sun Jul 26 2026 2:45 AM</kbd>- [Query-Time Entity Disambiguation in Graph RAG: When One Name Means Seventeen Nodes](https://dev.to/hannune/query-time-entity-disambiguation-in-graph-rag-when-one-name-means-seventeen-nodes-4kfg) <kbd>Sun Jul 26 2026 2:41 AM</kbd>- [The Best Approach to Dependency Vulnerability Scanning in CI Pipelines](https://dev.to/brino666/the-best-approach-to-dependency-vulnerability-scanning-in-ci-pipelines-4m64) <kbd>Sun Jul 26 2026 2:36 AM</kbd>- [claude-docker: one command, one container, full permissions](https://dev.to/rogue_paradigms/claude-docker-one-command-one-container-full-permissions-34e4) <kbd>Sun Jul 26 2026 2:21 AM</kbd><!-- BLOG-POST-LIST:END -->
