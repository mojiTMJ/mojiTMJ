...
<!-- BLOG-POST-LIST:START -->- [Laravel&#39;s Native Vector Search Now Speaks MariaDB — Plain MySQL Is Still Left Out](https://dev.to/gabbrowick/laravels-native-vector-search-now-speaks-mariadb-plain-mysql-is-still-left-out-i2p) <kbd>Tue Sep 08 2026 4:13 PM</kbd>- [Thirty Days to Migrate: When Your SaaS Depends on a Model That&#39;s About to Disappear](https://dev.to/gabbrowick/thirty-days-to-migrate-when-your-saas-depends-on-a-model-thats-about-to-disappear-703) <kbd>Tue Sep 08 2026 4:13 PM</kbd>- [Why Building in Public Creates Free Marketing for Your Startup](https://dev.to/urielbitton/why-building-in-public-creates-free-marketing-for-your-startup-ppi) <kbd>Tue Sep 08 2026 4:11 PM</kbd>- [The Cable Buys Headroom: 91% of a USB 2.0 Bus, 3.6% of a Thunderbolt One](https://dev.to/gde/the-cable-buys-headroom-91-of-a-usb-20-bus-36-of-a-thunderbolt-one-563n) <kbd>Tue Sep 08 2026 4:09 PM</kbd>- [From Zero to Production AWS in One `terraform apply`: A Look at terraform-aws-infrastructure](https://dev.to/manishpcp/from-zero-to-production-aws-in-one-terraform-apply-a-look-at-terraform-aws-infrastructure-1n3e) <kbd>Tue Sep 08 2026 4:09 PM</kbd><!-- BLOG-POST-LIST:END -->
