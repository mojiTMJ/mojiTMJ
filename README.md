...
<!-- BLOG-POST-LIST:START -->- [Blocked Time Makes Free Capacity the Wrong Bet](https://dev.to/hackrs_3352/blocked-time-makes-free-capacity-the-wrong-bet-26mc) <kbd>Fri Sep 11 2026 4:05 PM</kbd>- [WaveRune: hiding a 32-bit ID inside a WAV file, and reading it back without the original](https://dev.to/godofweb/waverune-hiding-a-32-bit-id-inside-a-wav-file-and-reading-it-back-without-the-original-3mkk) <kbd>Fri Sep 11 2026 4:04 PM</kbd>- [LP Automation Tools Compared: VFat, Krystal, and MaxFi](https://dev.to/seredasv/lp-automation-tools-compared-vfat-krystal-and-maxfi-lof) <kbd>Fri Sep 11 2026 4:02 PM</kbd>- [SQL Window Functions 101](https://dev.to/young_odhiambo/sql-window-functions-101-5fli) <kbd>Fri Sep 11 2026 4:02 PM</kbd>- [If You Cannot Replay the Agent, Do Not Merge](https://dev.to/airs_6907/if-you-cannot-replay-the-agent-do-not-merge-ogh) <kbd>Fri Sep 11 2026 4:01 PM</kbd><!-- BLOG-POST-LIST:END -->
