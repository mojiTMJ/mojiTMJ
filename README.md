...
<!-- BLOG-POST-LIST:START -->- [OpenAI Responses API `user` Migration: Split Safety from Prompt Caching](https://dev.to/ssukhpinder/openai-responses-api-user-migration-split-safety-from-prompt-caching-32io) <kbd>Sun Aug 30 2026 4:15 PM</kbd>- [Auto-layout you don&#39;t have to build](https://dev.to/ramy_othman/auto-layout-you-dont-have-to-build-1311) <kbd>Sun Aug 30 2026 4:12 PM</kbd>- [Erasure coding en HDFS: cómo bajar el costo de replicar de 200% a 50%](https://dev.to/lu1tr0n/erasure-coding-en-hdfs-como-bajar-el-costo-de-replicar-de-200-a-50-4l2j) <kbd>Sun Aug 30 2026 4:12 PM</kbd>- [Build a workflow editor in Vue 3 — the whole thing](https://dev.to/ramy_othman/build-a-workflow-editor-in-vue-3-the-whole-thing-4602) <kbd>Sun Aug 30 2026 4:12 PM</kbd>- [Custom nodes without the props mystery](https://dev.to/ramy_othman/custom-nodes-without-the-props-mystery-3g6k) <kbd>Sun Aug 30 2026 4:12 PM</kbd><!-- BLOG-POST-LIST:END -->
