...
<!-- BLOG-POST-LIST:START -->- [Two Iceberg Clients, One Protocol: Where the Time Goes](https://dev.to/gde/two-iceberg-clients-one-protocol-where-the-time-goes-4g88) <kbd>Fri Sep 25 2026 4:40 PM</kbd>- [Two Iceberg Clients, One Protocol: Where the Time Goes](https://dev.to/aws-builders/two-iceberg-clients-one-protocol-where-the-time-goes-4a2c) <kbd>Fri Sep 25 2026 4:40 PM</kbd>- [Vite+ — Chapter 3: Vite+ in Practice](https://dev.to/othmane_nemli/vite-chapter-3-vite-in-practice-km7) <kbd>Fri Sep 25 2026 4:33 PM</kbd>- [A Coding Agent Tried to Fix My CameraX Rotation Bug by Waiting. I Asked for Proof Instead.](https://dev.to/hram/a-coding-agent-tried-to-fix-my-camerax-rotation-bug-by-waiting-i-asked-for-proof-instead-3fh9) <kbd>Fri Sep 25 2026 4:26 PM</kbd>- [NSA destina $3.9 mil M a IA: descubre el plan y actúa](https://dev.to/leojulieta/nsa-destina-39-mil-m-a-ia-descubre-el-plan-y-actua-5619) <kbd>Fri Sep 25 2026 4:26 PM</kbd><!-- BLOG-POST-LIST:END -->
