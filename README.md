...
<!-- BLOG-POST-LIST:START -->- [My AI agent tried to ship a mistake we&#39;d already reverted](https://dev.to/masondelan/my-ai-agent-tried-to-ship-a-mistake-wed-already-reverted-4737) <kbd>Mon Jul 06 2026 3:47 AM</kbd>- [The Subtraction Principle Part 2 — Why the Best Meditation Tools Do Less](https://dev.to/irislinl7r8/the-subtraction-principle-part-2-why-the-best-meditation-tools-do-less-42oa) <kbd>Mon Jul 06 2026 3:41 AM</kbd>- [WebSocket Reconnection That Actually Works: Auto-Reconnect Guide for Trading Bots](https://dev.to/matrixtrak/websocket-reconnection-that-actually-works-auto-reconnect-guide-for-trading-bots-3fe0) <kbd>Mon Jul 06 2026 3:41 AM</kbd>- [全く新しいApidog CLI + SKILLを開発した理由](https://dev.to/aakira/quan-kuxin-siiapidog-cli-skillwokai-fa-sitali-you-4fi1) <kbd>Mon Jul 06 2026 3:40 AM</kbd>- [My Fine-Tuned Gemma 4 Loaded Fine, Then Broke on the First Message](https://dev.to/jdshah/my-fine-tuned-gemma-4-loaded-fine-then-broke-on-the-first-message-5eg) <kbd>Mon Jul 06 2026 3:40 AM</kbd><!-- BLOG-POST-LIST:END -->
