...
<!-- BLOG-POST-LIST:START -->- [Free AWS, Azure and GCP architecture icons as SVG](https://dev.to/thegdsks/free-aws-azure-and-gcp-architecture-icons-as-svg-hn8) <kbd>Thu Sep 24 2026 3:49 AM</kbd>- [DAY 3 - SAGA Design Pattern](https://dev.to/technonotes/day-3-saga-design-pattern-59lh) <kbd>Thu Sep 24 2026 3:49 AM</kbd>- [Agentic AI vs AI Agents: Orchestration Beats a Lone Worker](https://dev.to/shaam_ai/agentic-ai-vs-ai-agents-orchestration-beats-a-lone-worker-4b5m) <kbd>Thu Sep 24 2026 3:44 AM</kbd>- [A 1.5MB Local LLM Manager That Turns llama.cpp Into a Complete Desktop AI Workstation](https://dev.to/oshine/a-15mb-local-llm-manager-that-turns-llamacpp-into-a-complete-desktop-ai-workstation-9a) <kbd>Thu Sep 24 2026 3:41 AM</kbd>- [Stop repeating HttpClient boilerplate in Angular](https://dev.to/renearias/stop-repeating-httpclient-boilerplate-in-angular-40n6) <kbd>Thu Sep 24 2026 3:33 AM</kbd><!-- BLOG-POST-LIST:END -->
