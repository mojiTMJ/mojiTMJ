...
<!-- BLOG-POST-LIST:START -->- [Codex vs Claude Code no .NET: minha experiência usando os dois](https://dev.to/tbertuzzi/codex-vs-claude-code-no-net-minha-experiencia-usando-os-dois-3a6b) <kbd>Fri Sep 04 2026 3:48 PM</kbd>- [Google OAuth 2.0 for Developers: Implementation, Security Best Practices, and Troubleshooting](https://dev.to/corsairdev/google-oauth-20-for-developers-implementation-security-best-practices-and-troubleshooting-39pl) <kbd>Fri Sep 04 2026 3:46 PM</kbd>- [The CORS Header Was Right There and the Browser Blocked It Anyway](https://dev.to/rbonweb/the-cors-header-was-right-there-and-the-browser-blocked-it-anyway-dgo) <kbd>Fri Sep 04 2026 3:44 PM</kbd>- [AI Tools to Safeguard Heritage: Real Solutions for Museums](https://dev.to/leojulieta/ai-tools-to-safeguard-heritage-real-solutions-for-museums-48pn) <kbd>Fri Sep 04 2026 3:43 PM</kbd>- [CrackMe Level 6: part 2](https://dev.to/ddupard/crackme-level-6-part-2-54k3) <kbd>Fri Sep 04 2026 3:43 PM</kbd><!-- BLOG-POST-LIST:END -->
